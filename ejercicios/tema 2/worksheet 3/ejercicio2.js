function muestraMayusculaOMinuscula(cadena)
{
    for (palabra of cadena.split(" "))
    {
        ...
        {
            if (lista_mayusculas.includes(palabra.charCodeAt(palabra[i])) == true)
            {
                mayusculas += 1
            }
            else if (lista_minusculas.includes(palabra.charCodeAt(palabra[i])) == true)
            {
                minusculas += 1
            }
        }
        ...
        {
            document.write(palabra + " : mayuscula" + "<br>")
        }
        if (mayusculas == 0 && minusculas > 0)
        {
            document.write(palabra + " : minuscula" + "<br>")
        }
        if (mayusculas > 0 && minusculas > 0)
        {
...
let cadena = "ALGUNAS DE esTas Palabras estan EN  MAYUSCULA, otras ESTAN en minUsculA Y otras Mezcladas"
